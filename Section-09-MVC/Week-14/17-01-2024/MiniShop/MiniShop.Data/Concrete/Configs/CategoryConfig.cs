...
namespace MiniShop.Data.Concrete.Configs
{
    public class CategoryConfig : IEntityTypeConfiguration<Category>
    {
        ...
        {
            builder.HasKey(c => c.Id);// bunu yazmak zorunda değiliz.EF Ctategorynin Id propertsini görünce anlıyo çünkü.
            builder.Property(c => c.Id).ValueGeneratedOnAdd();// bunu yazmak zorunda değiliz.
