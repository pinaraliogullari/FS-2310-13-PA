...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Db.CloseCn();//    sqlDataAdapter.Fill(dataTable); aslýnda bu iþlemden sonra server otomatik kapatýlýr.
        ...
        SqlCommand cmd = new SqlCommand(queryString, Db.connection);     //SqlAdaptere alternatif olarak; çalýþtýrma sürecine bu yöntemle daha çok karýþabilriiz.
