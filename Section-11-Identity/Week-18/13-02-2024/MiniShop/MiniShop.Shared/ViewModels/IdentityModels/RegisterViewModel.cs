...
namespace MiniShop.Shared.ViewModels.IdentityModels
{
    ...
    {
        [DisplayName("Ad")]
        [Required(ErrorMessage ="Lütfen ad boş bırakmayınız")]
        public string FirstName { get; set; }


        [DisplayName("Soyad")]
        [Required(ErrorMessage = "Lütfen soyad boş bırakmayınız")]
        ...
        [DisplayName("Email")]
        [Required(ErrorMessage = "Lütfen email alanını bırakmayınız")]
